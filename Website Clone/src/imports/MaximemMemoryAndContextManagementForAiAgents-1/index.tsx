import svgPaths from "./svg-wuwadlczpe";
import imgCanvas from "./41f31794f4832a59ff417534d341e2838abf31e3.png";
import imgImage from "./a4f1d3c1f4f339c51188430eb8c65ec167cc6328.png";
import imgImage1 from "./bde9e2000ea3d2e071140afe25ecd0a77821cf12.png";
import imgImage2 from "./57658469841f9d4846bb556243c1ddc3bd3cc86b.png";
import imgImageOmnidimension from "./f2a46a515c2dab8f9b4c7ae24afb71cca9294bc4.png";
import imgImage3 from "./3966c318087c34a87eab639481bcab8d2619c9a2.png";
import imgImage4 from "./fd9e1e5c04b3fa7ffcf2e0956c3d9d406b68457b.png";
import imgImage5 from "./5accd1373992738d0ddea3a5f06b409abe9879dc.png";
import imgImage6 from "./33a14a1ee5ee5d513eea0b796e0410cbfb4d8478.png";
import imgImageClearVue from "./40fa724e97ae2d6317abc3a458115e27355b8383.png";
import imgImage7 from "./ac91258f549b9924be02e9f8382d107c5ba8c279.png";
import imgImageNexusVenturePartners from "./ea8e428bcf8309be5780d7de5255c64c76d1dcd3.png";
import imgImage8 from "./0f3b3f8acae7bd1f4962f38f04a4e721bfa1df43.png";
import imgImageNeo4J from "./911b19730f3b929e0024b0dfa7c933bf0ec8447b.png";
import imgImagePoweredByAws from "./84e327ff56180cce3616c360143e2d92910f6296.png";
import imgImageClaudeSkillsForAiEngineers2026MidYearEdition11SkillsThatFillLastYearsGaps from "./6bf0a82de0f435acdf2709da1b099cd4c24bf460.png";
import imgImageMcp2026072820BreakingChangesAndTheErrorsTheyCause from "./d8ed252916b8f0dab62ac88c5a241e8a1f7ba05c.png";
import imgImageAgenticContextManagementAgentMemoryIsNotMerelyAStorageRetrievalProblemItIsAnArchitectureProblem from "./d58a9ec38402123c051d047262f1de8219af0c4b.png";
import imgCanvas1 from "./7ab3ad669caeee84fc649e8d76ad90fb9d08a056.png";
import imgContainer from "./e49092636a580de3385d2e46a97ffb69f1ab726d.png";
...
function Canvas() {
  return (
    <div className="absolute h-[807px] left-0 top-0 w-[1425px]" data-name="Canvas">
...
function Heading() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 1">
      <p className="[word-break:break-word] font-['Geist_Variable:Medium',sans-serif] leading-[63.8px] not-italic relative shrink-0 text-[58px] text-white tracking-[-1.4568px] w-[625px]">Build AI that remembers, learns and gets better over time.</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[29.25px] not-italic relative shrink-0 text-[18px] text-[rgba(255,255,255,0.8)] tracking-[-0.4395px] w-[575px]">Maximem gives AI agents persistent, structured memory and active context management; so every interaction makes them more personal, accurate and useful, while reducing token costs, and so that what your agents know becomes something a competitor cannot trivially copy.</p>
    </div>
  );
}
...
function Text() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Text">
      <p className="[word-break:break-word] font-['Geist_Variable:Semi_Bold',sans-serif] leading-[30px] not-italic relative shrink-0 text-[#f26522] text-[30px] tracking-[-0.3545px] whitespace-nowrap">92%</p>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="content-stretch flex flex-col h-[26px] items-start pt-[6px] relative shrink-0 w-[140.742px]" data-name="Text">
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[19.5px] not-italic relative shrink-0 text-[#a1a1aa] text-[13px] tracking-[-0.0762px] whitespace-nowrap">LongMemEval accuracy</p>
    </div>
  );
}
...
function Link() {
  return (
    <div className="content-stretch flex flex-col items-start relative rounded-[12px] shrink-0 w-[140.742px]" data-name="Link">
      <Text />
      <Text1 />
    </div>
  );
...
function Text2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Text">
      <p className="[word-break:break-word] font-['Geist_Variable:Semi_Bold',sans-serif] leading-[30px] not-italic relative shrink-0 text-[30px] text-white tracking-[-0.3545px] whitespace-nowrap">93.2%</p>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="content-stretch flex flex-col h-[26px] items-start pt-[6px] relative shrink-0 w-[106.555px]" data-name="Text">
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[19.5px] not-italic relative shrink-0 text-[#a1a1aa] text-[13px] tracking-[-0.0762px] whitespace-nowrap">LoCoMo accuracy</p>
    </div>
  );
}
...
function Link1() {
  return (
    <div className="content-stretch flex flex-col items-start relative rounded-[12px] shrink-0 w-[106.555px]" data-name="Link">
      <Text2 />
      <Text3 />
    </div>
  );
...
function Text4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Text">
      <p className="[word-break:break-word] font-['Geist_Variable:Semi_Bold',sans-serif] leading-[30px] not-italic relative shrink-0 text-[30px] text-white tracking-[-0.3545px] whitespace-nowrap">{`<15ms`}</p>
    </div>
  );
}
...
function Text5() {
  return (
    <div className="content-stretch flex flex-col h-[26px] items-start pt-[6px] relative shrink-0 w-[170.578px]" data-name="Text">
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[19.5px] not-italic relative shrink-0 text-[#a1a1aa] text-[13px] tracking-[-0.0762px] whitespace-nowrap">P75 in-conversation retrieval</p>
    </div>
  );
}
...
function Link2() {
  return (
    <div className="content-stretch flex flex-col items-start relative rounded-[12px] shrink-0 w-[170.578px]" data-name="Link">
      <Text4 />
      <Text5 />
    </div>
  );
...
function MaximemSynapBenchmarkResults() {
  return (
    <div className="content-stretch flex gap-[40px] items-start relative shrink-0 w-full" data-name="Maximem Synap benchmark results">
      <Link />
      <Link1 />
      <Link2 />
    </div>
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="16" preserveAspectRatio="none" viewBox="0 0 16 16" width="16">
        <g id="Icon">
          <path d="M3.33333 8H12.6667" id="Vector" stroke="black" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p1d405500} id="Vector_2" stroke="black" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Button() {
  return (
    <div className="absolute bg-white content-stretch drop-shadow-[0px_0px_6px_rgba(242,101,34,0.25)] flex gap-[8px] h-[48px] items-center left-0 px-[28px] py-[12px] rounded-[16px] top-0" data-name="Button">
      <p className="[word-break:break-word] font-['Geist_Variable:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-black text-center tracking-[-0.3125px] whitespace-nowrap">Get Started Free</p>
      <Icon />
    </div>
  );
}
...
function Container4() {
  return (
    <div className="h-[48px] relative shrink-0 w-[203.836px]" data-name="Container">
      <Button />
    </div>
  );
}
...
function Icon1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="16" preserveAspectRatio="none" viewBox="0 0 16 16" width="16">
        <g id="Icon">
          <path d="M3.33333 8H12.6667" id="Vector" stroke="#A1A1AA" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p1d405500} id="Vector_2" stroke="#A1A1AA" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Link3() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Link">
      <p className="[word-break:break-word] font-['Geist_Variable:Medium',sans-serif] leading-[22.5px] not-italic relative shrink-0 text-[#a1a1aa] text-[15px] tracking-[-0.2344px] whitespace-nowrap">Try in Playground</p>
      <Icon1 />
    </div>
  );
}
...
function Container3() {
  return (
    <div className="content-stretch flex gap-[20px] items-center relative shrink-0 w-[624.523px]" data-name="Container">
      <Container4 />
      <Link3 />
    </div>
  );
...
function Container2() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[28px] h-[525.141px] items-start justify-center left-0 top-[-40px] w-[624.523px]" data-name="Container">
      <Heading />
      <Paragraph />
      <MaximemSynapBenchmarkResults />
      <Container3 />
    </div>
  );
}
...
function ContainerMargin() {
  return (
    <div className="content-stretch flex flex-col h-[485.141px] items-start relative shrink-0 w-[624.523px]" data-name="Container:margin">
      <Container2 />
    </div>
  );
}
...
function Group1() {
  return (
    <div className="absolute contents inset-[43.37%_76.42%_43.37%_14.05%]" data-name="Group">
      <div className="absolute inset-[43.37%_76.42%_43.37%_14.05%]" data-name="Vector">
        <svg className="absolute block inset-0 size-full" fill="none" height="47.5258" preserveAspectRatio="none" viewBox="0 0 54.7259 47.5258" width="54.7259">
          <path d={svgPaths.p34677500} fill="#F26522" id="Vector" />
        </svg>
      </div>
    </div>
  );
...
function Group() {
  return (
    <div className="absolute contents inset-[41.33%_75.78%_36.76%_13.41%]" data-name="Group">
      <div className="absolute inset-[41.33%_75.78%_41.33%_13.41%]" data-name="Vector">
        <svg className="absolute block inset-0 size-full" fill="none" height="62.1048" preserveAspectRatio="none" viewBox="0 0 62.1048 62.1048" width="62.1048">
          <path d={svgPaths.p17b45f00} fill="#F26522" fillOpacity="0.13" id="Vector" opacity="0.386287" />
        </svg>
      </div>
      <div className="absolute inset-[43.33%_77.03%_43.33%_14.66%]" data-name="Vector">
        <div className="absolute inset-[-1.25%]">
          <svg className="block size-full" fill="none" height="48.9673" preserveAspectRatio="none" viewBox="0 0 48.9673 48.9673" width="48.9673">
            <path d={svgPaths.pa31c8c0} fill="#1B1B19" id="Vector" stroke="#F26522" strokeOpacity="0.4" strokeWidth="1.19432" />
          </svg>
        </div>
      </div>
      <Group1 />
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal inset-[60.17%_78.49%_36.76%_16.11%] leading-[normal] not-italic text-[#b07248] text-[8.957px] text-center whitespace-nowrap">SYNAP</p>
    </div>
  );
}
...
function Group2() {
  return (
    <div className="absolute contents inset-[18.67%_31.29%_72.67%_43.76%]" data-name="Group">
      <div className="absolute inset-[18.67%_31.29%_72.67%_43.76%]" data-name="Vector">
        <div className="absolute inset-[-1.92%_-0.42%]">
          <svg className="block size-full" fill="none" height="32.2467" preserveAspectRatio="none" viewBox="0 0 144.513 32.2467" width="144.513">
            <path d={svgPaths.p1125cc80} fill="white" fillOpacity="0.03" id="Vector" stroke="white" strokeOpacity="0.1" strokeWidth="1.19432" />
          </svg>
        </div>
      </div>
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal inset-[20.83%_42.19%_74.98%_46.67%] leading-[normal] not-italic text-[#c9c4bb] text-[12.54px] whitespace-nowrap">LangChain</p>
    </div>
  );
}
...
function Group3() {
  return (
    <div className="absolute contents inset-[30%_31.29%_61.33%_43.76%]" data-name="Group">
      <div className="absolute inset-[30%_31.29%_61.33%_43.76%]" data-name="Vector">
        <div className="absolute inset-[-1.92%_-0.42%]">
          <svg className="block size-full" fill="none" height="32.2467" preserveAspectRatio="none" viewBox="0 0 144.513 32.2467" width="144.513">
            <path d={svgPaths.p1125cc80} fill="white" fillOpacity="0.03" id="Vector" stroke="white" strokeOpacity="0.1" strokeWidth="1.19432" />
          </svg>
      ...
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal inset-[32.17%_41.84%_63.65%_46.67%] leading-[normal] not-italic text-[#c9c4bb] text-[12.54px] whitespace-nowrap">LangGraph</p>
    </div>
  );
}
...
function Group4() {
  return (
    <div className="absolute bottom-1/2 contents left-[43.76%] right-[31.29%] top-[41.33%]" data-name="Group">
      <div className="absolute bottom-1/2 left-[43.76%] right-[31.29%] top-[41.33%]" data-name="Vector">
        <div className="absolute inset-[-1.92%_-0.42%]">
          <svg className="block size-full" fill="none" height="32.2467" preserveAspectRatio="none" viewBox="0 0 144.513 32.2467" width="144.513">
            <path d={svgPaths.p1125cc80} fill="white" fillOpacity="0.03" id="Vector" stroke="white" strokeOpacity="0.1" strokeWidth="1.19432" />
          </svg>
      ...
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal inset-[43.5%_41.49%_52.31%_46.67%] leading-[normal] not-italic text-[#c9c4bb] text-[12.54px] whitespace-nowrap">LlamaIndex</p>
    </div>
  );
}
...
function Group5() {
  return (
    <div className="absolute contents inset-[52.67%_31.29%_38.67%_43.76%]" data-name="Group">
      <div className="absolute inset-[52.67%_31.29%_38.67%_43.76%]" data-name="Vector">
        <div className="absolute inset-[-1.92%_-0.42%]">
          <svg className="block size-full" fill="none" height="32.2467" preserveAspectRatio="none" viewBox="0 0 144.513 32.2467" width="144.513">
            <path d={svgPaths.p1125cc80} fill="white" fillOpacity="0.03" id="Vector" stroke="white" strokeOpacity="0.1" strokeWidth="1.19432" />
          </svg>
      ...
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal inset-[54.83%_45.84%_40.98%_46.67%] leading-[normal] not-italic text-[#c9c4bb] text-[12.54px] whitespace-nowrap">CrewAI</p>
    </div>
  );
}
...
function Group6() {
  return (
    <div className="absolute contents inset-[64%_31.29%_27.33%_43.76%]" data-name="Group">
      <div className="absolute inset-[64%_31.29%_27.33%_43.76%]" data-name="Vector">
        <div className="absolute inset-[-1.92%_-0.42%]">
          <svg className="block size-full" fill="none" height="32.2467" preserveAspectRatio="none" viewBox="0 0 144.513 32.2467" width="144.513">
            <path d={svgPaths.p1125cc80} fill="white" fillOpacity="0.03" id="Vector" stroke="white" strokeOpacity="0.1" strokeWidth="1.19432" />
          </svg>
      ...
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal inset-[66.17%_46.19%_29.65%_46.67%] leading-[normal] not-italic text-[#c9c4bb] text-[12.54px] whitespace-nowrap">LiveKit</p>
    </div>
  );
}
...
function Group7() {
  return (
    <div className="absolute contents inset-[75.33%_31.29%_16%_43.76%]" data-name="Group">
      <div className="absolute inset-[75.33%_31.29%_16%_43.76%]" data-name="Vector">
        <div className="absolute inset-[-1.92%_-0.42%]">
          <svg className="block size-full" fill="none" height="32.2467" preserveAspectRatio="none" viewBox="0 0 144.513 32.2467" width="144.513">
            <path d={svgPaths.p1125cc80} fill="white" fillOpacity="0.03" id="Vector" stroke="white" strokeOpacity="0.1" strokeWidth="1.19432" />
          </svg>
      ...
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal inset-[77.5%_44.1%_18.31%_46.67%] leading-[normal] not-italic text-[#c9c4bb] text-[12.54px] whitespace-nowrap">Vercel AI</p>
    </div>
  );
}
...
function Group8() {
  return (
    <div className="[word-break:break-word] absolute contents inset-[36%_8.91%_41.32%_77.44%] leading-[normal] not-italic whitespace-nowrap" data-name="Group">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold inset-[36%_13.33%_50.32%_77.44%] text-[40.607px] text-white">23</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[50.33%_8.91%_46.04%_77.86%] text-[#b6b1a8] text-[10.749px]">FRAMEWORKS</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[55.33%_9.78%_41.32%_77.86%] text-[#7c776f] text-[9.555px]">native · one line</p>
    </div>
  );
}

function ImageSynapIsAMemoryCoreThatDropsInto23AgentFrameworksNativelyLangChainLangGraphLlamaIndexCrewAiLiveKitVercelAiAndMoreInOneLine() {
  return (
    <div className="h-[358.297px] overflow-clip relative shrink-0 w-full" data-name="Image - Synap is a memory core that drops into 23 agent frameworks natively — LangChain, LangGraph, LlamaIndex, CrewAI, LiveKit, Vercel AI and more — in one line.">
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal inset-[9.33%_70.51%_86.76%_6.34%] leading-[normal] not-italic text-[#b07248] text-[11.943px] whitespace-nowrap">DROP-IN INTEGRATION</p>
      <div className="absolute bottom-1/2 left-[18.82%] right-[56.24%] top-[23%]" data-name="Vector">
        <div className="absolute inset-[-0.61%_-0.28%]">
          <svg className="block size-full" fill="none" height="97.9281" preserveAspectRatio="none" viewBox="0 0 144.121 97.9281" width="144.121">
            <path d={svgPaths.p3bc96140} id="Vector" stroke="#F26522" strokeOpacity="0.35" strokeWidth="1.43319" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-1/2 left-[18.82%] right-[56.24%] top-[34.33%]" data-name="Vector">
        <div className="absolute inset-[-1.19%_-0.18%]">
          <svg className="block size-full" fill="none" height="57.4677" preserveAspectRatio="none" viewBox="0 0 143.841 57.4677" width="143.841">
            <path d={svgPaths.pde29e00} id="Vector" stroke="#F26522" strokeOpacity="0.35" strokeWidth="1.43319" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-1/2 left-[18.82%] right-[56.24%] top-[45.67%]" data-name="Vector">
        <div className="absolute inset-[-4.59%_0]">
          <svg className="block size-full" fill="none" height="16.9511" preserveAspectRatio="none" viewBox="0 0 143.473 16.9511" width="143.473">
            <path d={svgPaths.p6149100} id="Vector" stroke="#F26522" strokeOpacity="0.35" strokeWidth="1.43319" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-[43%] left-[18.82%] right-[56.24%] top-1/2" data-name="Vector">
        <div className="absolute inset-[-2.81%_0]">
          <svg className="block size-full" fill="none" height="26.4925" preserveAspectRatio="none" viewBox="0 0 143.566 26.4925" width="143.566">
            <path d={svgPaths.p119eaa40} id="Vector" stroke="#F26522" strokeOpacity="0.35" strokeWidth="1.43319" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-[31.67%] left-[18.82%] right-[56.24%] top-1/2" data-name="Vector">
        <div className="absolute inset-[-0.99%_-0.21%]">
          <svg className="block size-full" fill="none" height="66.9906" preserveAspectRatio="none" viewBox="0 0 143.916 66.9906" width="143.916">
            <path d={svgPaths.p2a6407c0} id="Vector" stroke="#F26522" strokeOpacity="0.35" strokeWidth="1.43319" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-[20.33%] left-[18.82%] right-[56.24%] top-1/2" data-name="Vector">
        <div className="absolute inset-[-0.54%_-0.3%]">
          <svg className="block size-full" fill="none" height="107.446" preserveAspectRatio="none" viewBox="0 0 144.173 107.446" width="144.173">
            <path d={svgPaths.pda5c700} id="Vector" stroke="#F26522" strokeOpacity="0.35" strokeWidth="1.43319" />
          </svg>
        </div>
      </div>
      <Group />
      ...
      <Group6 />
      <Group7 />
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal inset-[84.33%_47.36%_12.04%_43.76%] leading-[normal] not-italic text-[#7c776f] text-[10.749px] whitespace-nowrap">+ 17 more</p>
      <Group8 />
    </div>
  );
}
...
function Container6() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 top-0 w-[574.477px]" data-name="Container">
      <ImageSynapIsAMemoryCoreThatDropsInto23AgentFrameworksNativelyLangChainLangGraphLlamaIndexCrewAiLiveKitVercelAiAndMoreInOneLine />
    </div>
  );
}

function ButtonShowAccuracyOverALongConversation() {
  return <div className="bg-[rgba(255,255,255,0.25)] h-[3px] relative rounded-[9999px] shrink-0 w-[14px]" data-name="Button - Show: Accuracy over a long conversation" />;
}

function ButtonShowRecallLatency() {
  return <div className="bg-[rgba(255,255,255,0.25)] h-[3px] relative rounded-[9999px] shrink-0 w-[14px]" data-name="Button - Show: Recall latency" />;
}

function ButtonShow23FrameworkIntegrations() {
  return <div className="bg-[#f26522] h-[3px] relative rounded-[9999px] shrink-0 w-[28px]" data-name="Button - Show: 23 framework integrations" />;
}

function Container7() {
  return (
    <div className="absolute content-stretch flex gap-[10px] items-center justify-center left-0 top-[343.3px] w-[574.477px]" data-name="Container">
      <ButtonShowAccuracyOverALongConversation />
      <ButtonShowRecallLatency />
      <ButtonShow23FrameworkIntegrations />
    </div>
  );
}
...
function Container5() {
  return (
    <div className="bg-[#1b1b19] border border-[#423f39] border-solid h-[360.297px] overflow-clip relative rounded-[32px] shrink-0 w-[576.477px]" data-name="Container">
      <Container6 />
      <Container7 />
    </div>
  );
...
function Container1() {
  return (
    <div className="absolute content-stretch flex gap-[64px] h-[727px] items-center left-[80px] py-[32px] top-[80px] w-[1265px]" data-name="Container">
      <ContainerMargin />
      <Container5 />
    </div>
  );
...
function Section() {
  return (
    <div className="h-[807px] max-w-[1600px] min-h-[807px] overflow-clip relative shrink-0 w-full" style={{ backgroundImage: "linear-gradient(180deg, rgba(14, 14, 13, 0) 80%, rgb(14, 14, 13) 100%), linear-gradient(90deg, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 100%), linear-gradient(90deg, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 100%), linear-gradient(180deg, rgb(14, 14, 13) 0%, rgb(17, 15, 14) 40%, rgb(23, 19, 15) 70%, rgb(31, 24, 16) 90%, rgb(14, 14, 13) 100%)" }} data-name="Section">
      <Canvas />
      <Container1 />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[26px]" data-name="Image">
      <svg className="absolute block inset-0 size-full" fill="none" height="26" preserveAspectRatio="none" viewBox="0 0 26 26" width="26">
        <g clipPath="url(#clip0_0_29)" id="Image" opacity="0.55">
  ...
  return (
    <div className="h-[26px] relative shrink-0 w-[35px]" data-name="Image">
      <svg className="absolute block inset-0 size-full" fill="none" height="26" preserveAspectRatio="none" viewBox="0 0 35 26" width="35">
        <g clipPath="url(#clip0_0_118)" id="Image" opacity="0.55">
    ...
    <div className="h-[31px] max-h-[31.5px] max-w-[150px] relative shrink-0 w-[125px]" data-name="Image (Hector AI)">
      <svg className="absolute block inset-0 size-full" fill="none" height="31" preserveAspectRatio="none" viewBox="0 0 125 31" width="125">
        <g id="Image (Hector AI)" opacity="0.55">
          <path d={svgPaths.p10099e80} fill="url(#paint0_linear_0_158)" id="Vector" />
          <path d={svgPaths.p1b59c400} fill="url(#paint1_linear_0_158)" id="Vector_2" />
          <path d={svgPaths.p3644f240} fill="url(#paint2_linear_0_158)" id="Vector_3" />
          <path d={svgPaths.p1e994e80} fill="url(#paint3_linear_0_158)" id="Vector_4" />
        ...
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_158" x1="4.71218" x2="19.5338" y1="4.62582" y2="30.0912">
          ...
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_0_158" x1="9.48741" x2="25.4503" y1="0.664228" y2="28.0902">
            <stop offset="2.75506e-07" stopColor="#FF0078" />
            <stop offset="0.0636" stopColor="#E80089" />
            <stop offset="0.1972" stopColor="#AD00B4" />
            <stop offset="0.3511" stopColor="#6200EB" />
          ...
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_0_158" x1="4.35072" x2="22.164" y1="3.45621" y2="34.0616">
            <stop offset="2.75506e-07" stopColor="#FF0078" />
            <stop offset="0.0636" stopColor="#E80089" />
            <stop offset="0.1972" stopColor="#AD00B4" />
            <stop offset="0.3511" stopColor="#6200EB" />
          ...
          <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_0_158" x1="18.4544" x2="34.4172" y1="-4.55463" y2="22.8714">
            <stop offset="2.75506e-07" stopColor="#FF0078" />
            <stop offset="0.0636" stopColor="#E80089" />
            <stop offset="0.1972" stopColor="#AD00B4" />
            <stop offset="0.3511" stopColor="#6200EB" />
...
function ImageHectorAi1() {
  return (
    <div className="h-[31px] max-h-[31.5px] max-w-[150px] relative shrink-0 w-[125px]" data-name="Image (Hector AI)">
      <svg className="absolute block inset-0 size-full" fill="none" height="31" preserveAspectRatio="none" viewBox="0 0 125 31" width="125">
        <g id="Image (Hector AI)" opacity="0.55">
          <path d={svgPaths.p3ca40000} fill="url(#paint0_linear_0_147)" id="Vector" />
          <path d={svgPaths.p1b59c400} fill="url(#paint1_linear_0_147)" id="Vector_2" />
          <path d={svgPaths.p3644f240} fill="url(#paint2_linear_0_147)" id="Vector_3" />
          <path d={svgPaths.p36e15280} fill="url(#paint3_linear_0_147)" id="Vector_4" />
        ...
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_147" x1="4.71271" x2="19.5344" y1="4.62582" y2="30.0913">
            <stop offset="2.75506e-07" stopColor="#FF0078" />
            <stop offset="0.0636" stopColor="#E80089" />
            <stop offset="0.1972" stopColor="#AD00B4" />
            <stop offset="0.3511" stopColor="#6200EB" />
          ...
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_0_147" x1="9.48741" x2="25.4503" y1="0.664228" y2="28.0902">
            <stop offset="2.75506e-07" stopColor="#FF0078" />
            <stop offset="0.0636" stopColor="#E80089" />
            <stop offset="0.1972" stopColor="#AD00B4" />
            <stop offset="0.3511" stopColor="#6200EB" />
          ...
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_0_147" x1="4.35072" x2="22.164" y1="3.45621" y2="34.0616">
            <stop offset="2.75506e-07" stopColor="#FF0078" />
            <stop offset="0.0636" stopColor="#E80089" />
            <stop offset="0.1972" stopColor="#AD00B4" />
            <stop offset="0.3511" stopColor="#6200EB" />
          ...
          <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_0_147" x1="18.454" x2="34.4168" y1="-4.55462" y2="22.8714">
            <stop offset="2.75506e-07" stopColor="#FF0078" />
            <stop offset="0.0636" stopColor="#E80089" />
            <stop offset="0.1972" stopColor="#AD00B4" />
            <stop offset="0.3511" stopColor="#6200EB" />
  ...
  return (
    <div className="absolute inset-[27.31%_0.33%_25.63%_0.26%]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" height="15.059" preserveAspectRatio="none" viewBox="0 0 218.695 15.059" width="218.695">
        <g id="Group">
          <path d={svgPaths.p40d1e80} fill="black" id="Vector" />
          <path d={svgPaths.p1278fa70} fill="black" id="Vector_2" />
          <path d={svgPaths.pb360100} fill="black" id="Vector_3" />
          <path d={svgPaths.pf27a100} fill="black" id="Vector_4" />
          <path d={svgPaths.p26e26380} fill="black" id="Vector_5" />
          <path d={svgPaths.p1f9b49c0} fill="black" id="Vector_6" />
          <path d={svgPaths.p2ad48900} fill="black" id="Vector_7" />
          <path d={svgPaths.p844f680} fill="black" id="Vector_8" />
          <path d={svgPaths.p382b3f00} fill="black" id="Vector_9" />
          <path d={svgPaths.p25f7b280} fill="black" id="Vector_10" />
          <path d={svgPaths.p107b3900} fill="black" id="Vector_11" />
          <path d={svgPaths.p3e53e800} fill="black" id="Vector_12" />
          <path d={svgPaths.p2c473890} fill="black" id="Vector_13" />
          <path d={svgPaths.p222b5500} fill="black" id="Vector_14" />
          <path d={svgPaths.p3fb31b00} fill="black" id="Vector_15" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="absolute inset-[11.76%_5.1%]" data-name="Inception Program">
      <svg className="absolute block inset-0 size-full" fill="none" height="36.7028" preserveAspectRatio="none" viewBox="0 0 99.8574 36.7028" width="99.8574">
        <g id="Inception Program">
          <path d={svgPaths.p14aac040} fill="black" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function ImageNvidiaInceptionProgram() {
  return (
    <div className="h-[47.992px] max-h-[48px] max-w-[150px] opacity-60 overflow-clip relative shrink-0 w-[111.203px]" data-name="Image (NVIDIA Inception Program)">
      <InceptionProgram />
    </div>
  );
}
  ...
  return (
    <div className="absolute inset-[9.18%_5.83%_4.71%_38.23%]" data-name="text3075">
      <svg className="absolute block inset-0 size-full" fill="none" height="15.6739" preserveAspectRatio="none" viewBox="0 0 83.9075 15.6739" width="83.9075">
        <g id="text3075">
          <path d={svgPaths.p2ec85500} fill="black" fillOpacity="0.541176" id="path3099" />
          <path d={svgPaths.p2abe3880} fill="black" fillOpacity="0.541176" id="path3101" />
          <path d={svgPaths.p152757b0} fill="black" fillOpacity="0.541176" id="path3103" />
          <path d={svgPaths.p2d132500} fill="black" fillOpacity="0.541176" id="path3105" />
          <path d={svgPaths.p1926bff2} fill="black" fillOpacity="0.541176" id="path3107" />
          <path d={svgPaths.p2f027e00} fill="black" fillOpacity="0.541176" id="path3109" />
          <path d={svgPaths.p1543a080} fill="black" fillOpacity="0.541176" id="path3111" />
          <path d={svgPaths.p76ac800} fill="black" fillOpacity="0.541176" id="path3113" />
          <path d={svgPaths.p1feadc00} fill="black" fillOpacity="0.541176" id="path3115" />
          <path d={svgPaths.pc6fe300} fill="black" fillOpacity="0.541176" id="path3117" />
        </g>
      </svg>
    </div>
  );
...
function Section1() {
  return (
    <div className="bg-[#0e0e0d] content-stretch flex flex-col gap-[48px] h-[748.992px] items-center px-[64px] py-[96px] relative shrink-0 w-full" data-name="Section">
      <Container9 />
      <Container11 />
      <Container12 />
      <Container13 />
...
function Paragraph1() {
  return (
    <div className="content-stretch flex flex-col items-center pt-[16px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['SF_Pro:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#d4d4d8] text-[0px] text-center tracking-[-0.4492px] w-[760px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <span className="font-['Geist_Variable:Regular',sans-serif] leading-[32.5px] text-[20px]">{`Maximem builds memory infrastructure: Synap, so the agents you build can remember, and Vity, a personal memory that stays `}</span>
        <span className="font-['Geist_Variable:Medium',sans-serif] leading-[32.5px] text-[20px] text-white">encrypted even from us</span>
        <span className="font-['Geist_Variable:Regular',sans-serif] leading-[32.5px] text-[20px]">, so the AI you use can too.</span>
      </p>
    </div>
  );
}
...
function Container16() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[332.5px] max-w-[760px] top-[96px] w-[760px]" data-name="Container">
      <Heading1 />
      <Paragraph1 />
    </div>
  );
...
function Container17() {
  return (
    <div className="absolute content-stretch flex gap-[32px] h-[420.07px] items-start left-[172.5px] max-w-[1080px] top-[312.7px] w-[1080px]" data-name="Container">
      <Container18 />
      <Container21 />
    </div>
  );
...
function Link7() {
  return (
    <div className="absolute content-stretch flex gap-[6px] h-[20px] items-center left-[628.51px] top-[767.27px]" data-name="Link">
...
function Section2() {
  return (
    <div className="bg-[#1b1b19] h-[884.766px] overflow-clip relative shrink-0 w-full" data-name="Section">
      <Text58 />
      <Text59 />
      <Container16 />
      <Container17 />
...
function Text66() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Geist_Mono_Variable:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#f26522] text-[12px] tracking-[1.2px] uppercase whitespace-nowrap">01</p>
    </div>
  );
}
...
function Text67() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Geist_Mono_Variable:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#56524b] text-[12px] tracking-[1.2px] uppercase whitespace-nowrap">/</p>
    </div>
  );
}
...
function Heading4() {
  return (
    <div className="content-stretch flex flex-col h-[72px] items-start pt-[16px] relative shrink-0 w-[1100px]" data-name="Heading 2">
      <p className="[word-break:break-word] font-['Geist_Variable:Medium',sans-serif] leading-[55.2px] not-italic relative shrink-0 text-[48px] text-white tracking-[-1.0884px] whitespace-nowrap">Why memory, and why the alternatives fall short.</p>
    </div>
  );
}
...
function ParagraphMargin() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[24px] pt-[16px] relative shrink-0" data-name="Paragraph:margin">
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[29.25px] not-italic relative shrink-0 text-[#d4d4d8] text-[18px] tracking-[-0.4395px] w-[768px]">Bigger context windows do not fix it. Vector search is not it. Files do not scale, and the platforms will not own it for you. We answer the nine loudest objections to agent memory, with proof.</p>
    </div>
  );
}
...
function Link8() {
  return (
    <div className="absolute h-[20px] left-0 top-[2.5px] w-[185.141px]" data-name="Link">
      <p className="[word-break:break-word] absolute font-['Geist_Variable:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#f26522] text-[14px] top-[-1px] tracking-[-0.1504px] whitespace-nowrap">Read the case for memory →</p>
    </div>
  );
}
...
function Section3() {
  return (
    <div className="bg-[#0e0e0d] content-stretch flex flex-col items-start px-[48px] py-[96px] relative shrink-0 w-full" data-name="Section">
      <ContainerMargin5 />
    </div>
  );
}
...
function Text69() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Geist_Mono_Variable:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#f26522] text-[12px] tracking-[1.2px] uppercase whitespace-nowrap">02</p>
    </div>
  );
}
...
function Heading5() {
  return (
    <div className="content-stretch flex flex-col h-[72px] items-start max-w-[768px] pt-[16px] relative shrink-0 w-[768px]" data-name="Heading 2">
      <p className="[word-break:break-word] font-['Geist_Variable:Medium',sans-serif] leading-[55.2px] not-italic relative shrink-0 text-[48px] text-white tracking-[-1.0884px] whitespace-nowrap">How Synap actually works</p>
    </div>
  );
}
  ...
  return (
    <div className="absolute contents inset-[13.45%_4.56%_16.9%_15.59%]" data-name="Group">
      <div className="absolute inset-[13.45%_4.56%_78.28%_29.41%]" data-name="Vector">
        <div className="absolute inset-[-19.27%_-1.03%]">
          <svg className="block size-full" fill="none" height="53.6882" preserveAspectRatio="none" viewBox="0 0 739.928 53.6882" width="739.928">
            <g filter="url(#filter0_f_0_24)" id="Vector" opacity="0.0365466">
              <path d={svgPaths.p3321dd80} stroke="#F26522" strokeWidth="2.01835" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="53.6882" id="filter0_f_0_24" width="739.928" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_0_24" stdDeviation="3.22937" />
              </filter>
            </defs>
          </svg>
        </div>
      ...
      <div className="absolute inset-[26.21%_59.93%_61.03%_30.51%]" data-name="Vector">
        <svg className="absolute block inset-0 size-full" fill="none" height="32" preserveAspectRatio="none" viewBox="0 0 32 32" width="32">
          <g filter="url(#filter0_f_0_82)" id="Vector" opacity="0">
            <path d={svgPaths.p33173c00} stroke="#F26522" strokeWidth="2.01835" />
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="-inf" id="filter0_f_0_82" width="-inf" x="inf" y="inf">
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
              <feGaussianBlur result="effect1_foregroundBlur_0_82" stdDeviation="3.22937" />
            </filter>
          </defs>
        </svg>
      </div>
      <div className="absolute inset-[26.21%_46.32%_61.03%_42.65%]" data-name="Vector">
        <svg className="absolute block inset-0 size-full" fill="none" height="32" preserveAspectRatio="none" viewBox="0 0 32 32" width="32">
          <g filter="url(#filter0_f_0_80)" id="Vector" opacity="0">
            <path d={svgPaths.p22155d00} stroke="#F26522" strokeWidth="2.01835" />
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="-inf" id="filter0_f_0_80" width="-inf" x="inf" y="inf">
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
              <feGaussianBlur result="effect1_foregroundBlur_0_80" stdDeviation="3.22937" />
            </filter>
          </defs>
        </svg>
      </div>
      <div className="absolute inset-[26.21%_33.09%_61.03%_58.09%]" data-name="Vector">
        <svg className="absolute block inset-0 size-full" fill="none" height="32" preserveAspectRatio="none" viewBox="0 0 32 32" width="32">
          <g filter="url(#filter0_f_0_81)" id="Vector" opacity="0">
            <path d={svgPaths.p2a151100} stroke="#F26522" strokeWidth="2.01835" />
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="-inf" id="filter0_f_0_81" width="-inf" x="inf" y="inf">
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
              <feGaussianBlur result="effect1_foregroundBlur_0_81" stdDeviation="3.22937" />
            </filter>
          </defs>
        </svg>
      </div>
      <div className="absolute inset-[43.45%_44.85%_45.17%_44.12%]" data-name="Vector">
        <svg className="absolute block inset-0 size-full" fill="none" height="32" preserveAspectRatio="none" viewBox="0 0 32 32" width="32">
          <g filter="url(#filter0_f_0_108)" id="Vector" opacity="0">
            <path d={svgPaths.p30787d00} stroke="#F26522" strokeWidth="2.01835" />
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="-inf" id="filter0_f_0_108" width="-inf" x="inf" y="inf">
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
              <feGaussianBlur result="effect1_foregroundBlur_0_108" stdDeviation="3.22937" />
            </filter>
          </defs>
        </svg>
      </div>
      ...
      <div className="absolute inset-[70%_30.51%_16.9%_55.51%]" data-name="Vector">
        <svg className="absolute block inset-0 size-full" fill="none" height="32" preserveAspectRatio="none" viewBox="0 0 32 32" width="32">
          <g filter="url(#filter0_f_0_78)" id="Vector" opacity="0">
            <path d={svgPaths.p1c497400} stroke="#F26522" strokeWidth="2.01835" />
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="-inf" id="filter0_f_0_78" width="-inf" x="inf" y="inf">
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
              <feGaussianBlur result="effect1_foregroundBlur_0_78" stdDeviation="3.22937" />
            </filter>
          </defs>
        </svg>
      </div>
      <div className="absolute inset-[43.45%_44.85%_45.17%_44.12%]" data-name="Vector">
        <div className="absolute inset-[-14.02%_-6.17%]">
          <svg className="block size-full" fill="none" height="68.2204" preserveAspectRatio="none" viewBox="0 0 136.037 68.2204" width="136.037">
            <g filter="url(#filter0_f_0_76)" id="Vector" opacity="0.01">
              <path d={svgPaths.p1e26da00} stroke="#F26522" strokeWidth="2.01835" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="68.2203" id="filter0_f_0_76" width="136.037" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_0_76" stdDeviation="3.22937" />
              </filter>
            </defs>
          </svg>
        </div>
      ...
      <div className="absolute inset-[43.1%_75.29%_41.03%_15.59%]" data-name="Vector">
        <div className="absolute inset-[-1.09%_-0.81%]">
          <svg className="block size-full" fill="none" height="75.8901" preserveAspectRatio="none" viewBox="0 0 101.725 75.8901" width="101.725">
            <path d={svgPaths.p3756e400} fill="url(#paint0_linear_0_187)" id="Vector" stroke="#F26522" strokeWidth="1.61468" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_187" x1="0.807341" x2="0.807341" y1="0.807341" y2="75.0827">
      ...
      <div className="absolute inset-[26.21%_59.93%_61.03%_30.51%]" data-name="Vector">
        <div className="absolute inset-[-1.01%_-0.58%]">
          <svg className="block size-full" fill="none" height="60.9543" preserveAspectRatio="none" viewBox="0 0 106.165 60.9543" width="106.165">
            <path d={svgPaths.p15c48f00} fill="url(#paint0_linear_0_66)" id="Vector" stroke="#56524B" strokeWidth="1.21101" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_66" x1="0.605506" x2="0.605506" y1="0.605506" y2="60.3488">
                <stop stopColor="#322F2B" />
                <stop offset="1" stopColor="#1B1B19" />
              </linearGradient>
            </defs>
      ...
      <div className="absolute inset-[26.21%_46.32%_61.03%_42.65%]" data-name="Vector">
        <div className="absolute inset-[-1.35%_-0.67%]">
          <svg className="block size-full" fill="none" height="61.3579" preserveAspectRatio="none" viewBox="0 0 122.716 61.3579" width="122.716">
            <path d={svgPaths.p5c7b900} fill="url(#paint0_linear_0_107)" id="Vector" stroke="#F26522" strokeWidth="1.61468" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_107" x1="0.807341" x2="0.807341" y1="0.807341" y2="60.5506">
                <stop stopColor="#322F2B" />
                <stop offset="1" stopColor="#1B1B19" />
              </linearGradient>
            </defs>
      ...
      <div className="absolute inset-[70%_30.51%_16.9%_55.51%]" data-name="Vector">
        <div className="absolute inset-[-1.32%_-0.53%]">
          <svg className="block size-full" fill="none" height="62.9726" preserveAspectRatio="none" viewBox="0 0 155.01 62.9726" width="155.01">
            <path d={svgPaths.p12803c80} fill="url(#paint0_linear_0_52)" id="Vector" stroke="#F26522" strokeWidth="1.61468" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_52" x1="0.807341" x2="0.807341" y1="0.807341" y2="62.1653">
                <stop stopColor="#322F2B" />
                <stop offset="1" stopColor="#1B1B19" />
              </linearGradient>
            </defs>
...
function Link9() {
  return (
    <div className="absolute h-[20px] left-0 top-[2.5px] w-[170.414px]" data-name="Link">
      <p className="[word-break:break-word] absolute font-['Geist_Variable:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#f26522] text-[14px] top-[-1px] tracking-[-0.1504px] whitespace-nowrap">See the full architecture →</p>
    </div>
  );
}
...
function Text72() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Geist_Mono_Variable:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#f26522] text-[12px] tracking-[1.2px] uppercase whitespace-nowrap">03</p>
    </div>
  );
}
...
function Text74() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Geist_Mono_Variable:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#a1a1aa] text-[12px] tracking-[1.2px] uppercase whitespace-nowrap">Benchmarks</p>
    </div>
  );
}
...
function Heading6() {
  return (
    <div className="content-stretch flex flex-col h-[72px] items-start pt-[16px] relative shrink-0 w-[1100px]" data-name="Heading 2">
      <p className="[word-break:break-word] font-['Geist_Variable:Medium',sans-serif] leading-[55.2px] not-italic relative shrink-0 text-[48px] text-white tracking-[-1.0884px] whitespace-nowrap">How Synap compares</p>
    </div>
  );
}
...
function Paragraph9() {
  return (
    <div className="content-stretch flex flex-col h-[46px] items-start max-w-[768px] pt-[16px] relative shrink-0 w-[768px]" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[29.25px] not-italic relative shrink-0 text-[#d4d4d8] text-[18px] tracking-[-0.4395px] whitespace-nowrap">The quick snapshot, measured on the same open-source LongMemEval harness.</p>
    </div>
  );
}
...
function HeaderCell() {
  return (
    <div className="col-1 content-stretch flex flex-col h-[52.5px] items-start justify-center p-[16px] relative row-1 shrink-0 w-[173.195px]" data-name="Header Cell">
      <div aria-hidden className="absolute border-[#423f39] border-b border-solid inset-0 pointer-events-none" />
    </div>
  );
}
...
function HeaderCell1() {
  return (
    <div className="bg-[rgba(242,101,34,0.12)] col-2 content-stretch flex flex-col h-[52.5px] items-start justify-center p-[16px] relative row-1 shrink-0 w-[213.5px]" data-name="Header Cell">
      <div aria-hidden className="absolute border-[#423f39] border-b border-solid inset-0 pointer-events-none" />
      <p className="[word-break:break-word] font-['Geist_Variable:Semi_Bold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-white tracking-[-0.1504px] whitespace-nowrap">Synap</p>
    </div>
  );
}
...
function HeaderCell2() {
  return (
    <div className="col-3 content-stretch flex flex-col h-[52.5px] items-start justify-center p-[16px] relative row-1 shrink-0 w-[135.688px]" data-name="Header Cell">
      <div aria-hidden className="absolute border-[#423f39] border-b border-solid inset-0 pointer-events-none" />
      <p className="[word-break:break-word] font-['Geist_Variable:Medium',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#d4d4d8] text-[14px] tracking-[-0.1504px] whitespace-nowrap">Mem0</p>
    </div>
  );
}
...
function HeaderCell3() {
  return (
    <div className="col-4 content-stretch flex flex-col h-[52.5px] items-start justify-center p-[16px] relative row-1 shrink-0 w-[416.141px]" data-name="Header Cell">
      <div aria-hidden className="absolute border-[#423f39] border-b border-solid inset-0 pointer-events-none" />
      <p className="[word-break:break-word] font-['Geist_Variable:Medium',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#d4d4d8] text-[14px] tracking-[-0.1504px] whitespace-nowrap">Zep</p>
    </div>
  );
}
...
function HeaderCell4() {
  return (
    <div className="col-5 content-stretch flex flex-col h-[52.5px] items-start justify-center p-[16px] relative row-1 shrink-0 w-[159.477px]" data-name="Header Cell">
      <div aria-hidden className="absolute border-[#423f39] border-b border-solid inset-0 pointer-events-none" />
      <p className="[word-break:break-word] font-['Geist_Variable:Medium',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#d4d4d8] text-[14px] tracking-[-0.1504px] whitespace-nowrap">Supermemory</p>
    </div>
  );
}
...
function HeaderCell5() {
  return (
    <div className="col-1 content-stretch flex flex-col h-[53px] items-start justify-center p-[16px] relative row-2 shrink-0 w-[173.195px]" data-name="Header Cell">
      <div aria-hidden className="absolute border-[#423f39] border-b border-solid inset-0 pointer-events-none" />
      <p className="[word-break:break-word] font-['Geist_Variable:Medium',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#d4d4d8] text-[14px] tracking-[-0.1504px] whitespace-nowrap">LongMemEval</p>
    </div>
  );
}
...
function TableCell() {
  return (
    <div className="bg-[rgba(242,101,34,0.12)] col-2 content-stretch flex flex-col h-[53px] items-start justify-center p-[16px] relative row-2 shrink-0 w-[213.5px]" data-name="Table Cell">
      <div aria-hidden className="absolute border-[#423f39] border-b border-solid inset-0 pointer-events-none" />
      <p className="[word-break:break-word] font-['Geist_Variable:Semi_Bold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-white tracking-[-0.1504px] whitespace-nowrap">92%</p>
    </div>
  );
}
...
function TableCell1() {
  return (
    <div className="col-3 content-stretch flex flex-col h-[53px] items-start justify-center p-[16px] relative row-2 shrink-0 w-[135.688px]" data-name="Table Cell">
      <div aria-hidden className="absolute border-[#423f39] border-b border-solid inset-0 pointer-events-none" />
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#a1a1aa] text-[14px] tracking-[-0.1504px] whitespace-nowrap">73.8%</p>
    </div>
  );
}
...
function TableCell2() {
  return (
    <div className="col-4 content-stretch flex flex-col h-[53px] items-start justify-center p-[16px] relative row-2 shrink-0 w-[416.141px]" data-name="Table Cell">
      <div aria-hidden className="absolute border-[#423f39] border-b border-solid inset-0 pointer-events-none" />
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#a1a1aa] text-[14px] tracking-[-0.1504px] whitespace-nowrap">{`71.2% (Zep's own figure; not run on our harness)`}</p>
    </div>
  );
}
...
function TableCell3() {
  return (
    <div className="col-5 content-stretch flex flex-col h-[53px] items-start justify-center p-[16px] relative row-2 shrink-0 w-[159.477px]" data-name="Table Cell">
      <div aria-hidden className="absolute border-[#423f39] border-b border-solid inset-0 pointer-events-none" />
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#a1a1aa] text-[14px] tracking-[-0.1504px] whitespace-nowrap">71.3%</p>
    </div>
  );
}
...
function HeaderCell6() {
  return (
    <div className="col-1 content-stretch flex flex-col h-[52.5px] items-start justify-center p-[16px] relative row-3 shrink-0 w-[173.195px]" data-name="Header Cell">
      <p className="[word-break:break-word] font-['Geist_Variable:Medium',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#d4d4d8] text-[14px] tracking-[-0.1504px] whitespace-nowrap">Entity resolution</p>
    </div>
  );
}
...
function TableCell4() {
  return (
    <div className="bg-[rgba(242,101,34,0.12)] col-2 content-stretch flex flex-col h-[52.5px] items-start justify-center p-[16px] relative row-3 shrink-0 w-[213.5px]" data-name="Table Cell">
      <p className="[word-break:break-word] font-['Geist_Variable:Semi_Bold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-white tracking-[-0.1504px] whitespace-nowrap">Automatic, every tier</p>
    </div>
  );
}
...
function TableCell5() {
  return (
    <div className="col-3 content-stretch flex flex-col h-[52.5px] items-start justify-center p-[16px] relative row-3 shrink-0 w-[135.688px]" data-name="Table Cell">
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#a1a1aa] text-[14px] tracking-[-0.1504px] whitespace-nowrap">Pro tier only</p>
    </div>
  );
}
...
function TableCell6() {
  return (
    <div className="col-4 content-stretch flex flex-col h-[52.5px] items-start justify-center p-[16px] relative row-3 shrink-0 w-[416.141px]" data-name="Table Cell">
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#a1a1aa] text-[14px] tracking-[-0.1504px] whitespace-nowrap">Automatic</p>
    </div>
  );
}
...
function TableCell7() {
  return (
    <div className="col-5 content-stretch flex flex-col h-[52.5px] items-start justify-center p-[16px] relative row-3 shrink-0 w-[159.477px]" data-name="Table Cell">
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#a1a1aa] text-[14px] tracking-[-0.1504px] whitespace-nowrap">Fact extraction</p>
    </div>
  );
}
...
function Table() {
  return (
    <div className="grid grid-cols-[_____173.20px_213.50px_135.69px_416.14px_159.48px] grid-rows-[___52.50px_53px_52.50px] h-[158px] min-w-[640px] relative shrink-0 w-full" data-name="Table">
      <HeaderCell />
      <HeaderCell1 />
      <HeaderCell2 />
      <HeaderCell3 />
...
function Container34() {
  return (
    <div className="border border-[#423f39] border-solid content-stretch flex flex-col h-[160px] items-start overflow-clip relative rounded-[24px] shrink-0 w-[1100px]" data-name="Container">
      <Table />
    </div>
  );
}
...
function Paragraph10() {
  return (
    <div className="content-stretch flex flex-col items-start pt-[16px] relative shrink-0 w-[1100px]" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[22.75px] not-italic relative shrink-0 text-[#a1a1aa] text-[14px] tracking-[-0.1504px] w-[1100px]">{`Measured on Maximem's open eval harness, same hardware, same prompts, same conversations, same scoring. Vendor self-reported figures differ and are shown separately. Zep has not been run on our harness, so its own published figure is shown instead. Full configuration and sources at /evals.`}</p>
    </div>
  );
}
...
function Container33() {
  return (
    <div className="content-stretch flex flex-col items-start py-[24px] relative shrink-0 w-[1100px]" data-name="Container">
      <Container34 />
      <Paragraph10 />
    </div>
  );
...
function Link10() {
  return (
    <div className="absolute h-[20px] left-0 top-[2.5px] w-[168.203px]" data-name="Link">
      <p className="[word-break:break-word] absolute font-['Geist_Variable:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#f26522] text-[14px] top-[-1px] tracking-[-0.1504px] whitespace-nowrap">See the full comparison →</p>
    </div>
  );
}
...
function Heading7() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="Heading 2">
      <p className="[word-break:break-word] font-['Geist_Variable:Medium',sans-serif] leading-[55.2px] not-italic relative shrink-0 text-[48px] text-center text-white tracking-[-1.0884px] whitespace-nowrap">Learn about Context Engineering</p>
    </div>
  );
}
...
function ParagraphMargin2() {
  return (
    <div className="content-stretch flex flex-col items-start pt-[16px] relative shrink-0" data-name="Paragraph:margin">
      <p className="[word-break:break-word] font-['SF_Pro:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#99a1af] text-[0px] text-center tracking-[-0.3125px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <span className="font-['Geist_Variable:Regular',sans-serif] leading-[24px] text-[16px]">{`Discover how `}</span>
        <span className="font-['Geist_Variable:Medium',sans-serif] leading-[24px] text-[16px] text-white">AI context</span>
        <span className="font-['Geist_Variable:Regular',sans-serif] leading-[24px] text-[16px]">{` and memory work. Check our `}</span>
        <span className="font-['Geist_Variable:Medium',sans-serif] leading-[24px] text-[16px] text-white">use cases</span>
        <span className="font-['Geist_Variable:Regular',sans-serif] leading-[24px] text-[16px]">{` and `}</span>
        <span className="font-['Geist_Variable:Medium',sans-serif] leading-[24px] text-[16px] text-white">Synap</span>
        <span className="font-['Geist_Variable:Regular',sans-serif] leading-[24px] text-[16px]">.</span>
      </p>
    </div>
  );
}
...
function Container38() {
  return (
    <div className="content-stretch flex flex-col h-[144px] items-center justify-center pb-[48px] px-[8px] relative shrink-0 w-[1329px]" data-name="Container">
      <Heading7 />
      <ParagraphMargin2 />
    </div>
  );
...
function Icon14() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="16" preserveAspectRatio="none" viewBox="0 0 16 16" width="16">
        <g id="Icon">
          <path d="M5.33333 1.33333V4" id="Vector" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M10.6667 1.33333V4" id="Vector_2" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p3ee34580} id="Vector_3" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M2 6.66667H14" id="Vector_4" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Container39() {
  return (
    <div className="gap-x-[40px] gap-y-[40px] grid grid-cols-[___406.66px_406.66px_406.66px] grid-rows-[_460.78px] max-w-[1300px] relative shrink-0 w-[1300px]" data-name="Container">
      <Container40 />
      <Container46 />
      <Container52 />
    </div>
...
function Paragraph14() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Paragraph">
      <p className="[word-break:break-word] font-['SF_Pro:Medium',sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#a1a1aa] text-[30px] tracking-[0.3955px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <span className="font-['Geist_Variable:Medium',sans-serif] leading-[37.5px]">{`Read `}</span>
        <span className="font-['Geist_Variable:Medium',sans-serif] leading-[37.5px] text-white">more</span>
      </p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="24" preserveAspectRatio="none" viewBox="0 0 24 24" width="24">
        <g id="Icon">
          <path d="M5 12H19" id="Vector" stroke="black" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M12 5L19 12L12 19" id="Vector_2" stroke="black" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Text78() {
  return (
    <div className="bg-white content-stretch flex items-center justify-center relative rounded-[9999px] shrink-0 size-[48px]" data-name="Text">
      <Icon20 />
    </div>
  );
}

function LinkReadMoreBlogPosts() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0" data-name="Link - Read more blog posts">
      <Paragraph14 />
      <Text78 />
    </div>
  );
...
function Container58() {
  return (
    <div className="content-stretch flex h-[96px] items-center justify-end max-w-[1300px] pt-[48px] relative shrink-0 w-[1300px]" data-name="Container">
      <LinkReadMoreBlogPosts />
    </div>
  );
}
...
function Container37() {
  return (
    <div className="bg-[#0e0e0d] content-stretch flex flex-col items-center max-w-[1800px] px-[48px] py-[96px] relative shrink-0 w-[1425px]" data-name="Container">
      <Container38 />
      <Container39 />
      <Container58 />
    </div>
...
function Section6() {
  return (
    <div className="bg-[#0e0e0d] content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Section">
      <Container37 />
    </div>
  );
}
...
function Canvas1() {
  return (
    <div className="absolute h-[130px] left-0 top-0 w-[1425px]" data-name="Canvas">
      <img alt="" className="absolute inset-0 max-w-none object-contain pointer-events-none size-full" src={imgCanvas1} />
    </div>
  );
}
...
function Heading11() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[448px] relative shrink-0 w-[448px]" data-name="Heading 2">
      <p className="[word-break:break-word] font-['Geist_Variable:Medium',sans-serif] leading-[33px] not-italic relative shrink-0 text-[24px] text-white tracking-[0.0703px] w-[448px]">The difference between a demo and a product is memory.</p>
    </div>
  );
}
...
function Button3() {
  return (
    <div className="absolute bg-white content-stretch drop-shadow-[0px_0px_6px_rgba(242,101,34,0.25)] flex gap-[8px] h-[42.5px] items-center left-0 px-[24px] py-[10px] rounded-[16px] top-0" data-name="Button">
      <p className="[word-break:break-word] font-['Geist_Variable:Medium',sans-serif] leading-[22.5px] not-italic relative shrink-0 text-[15px] text-black text-center tracking-[-0.2344px] whitespace-nowrap">Get Started Free</p>
      <Icon21 />
    </div>
  );
}
...
function Container62() {
  return (
    <div className="h-[42.5px] relative shrink-0 w-[188.102px]" data-name="Container">
      <Button3 />
    </div>
  );
}
...
function Link14() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Link">
      <p className="[word-break:break-word] font-['Geist_Variable:Medium',sans-serif] leading-[22.5px] not-italic relative shrink-0 text-[#d4d4d8] text-[15px] tracking-[-0.2344px] whitespace-nowrap">Talk to the founder</p>
    </div>
  );
}
...
function Container60() {
  return (
    <div className="content-stretch flex items-center justify-between max-w-[1040px] relative shrink-0 w-[1040px]" data-name="Container">
      <Heading11 />
      <Container61 />
    </div>
  );
...
function ContainerMargin9() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-0 px-[64px] py-[32px] top-0 w-[1425px]" data-name="Container:margin">
      <Container60 />
    </div>
  );
}
...
function Section8() {
  return (
    <div className="bg-[#0e0e0d] h-[130px] relative shrink-0 w-full" data-name="Section">
      <Canvas1 />
      <ContainerMargin9 />
    </div>
  );
...
function Section7() {
  return (
    <div className="bg-[#1b1b19] content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Section">
      <Section8 />
    </div>
  );
}
...
function Footer() {
  return (
    <div className="border-[#423f39] border-solid border-t content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Footer">
      <Footer1 />
    </div>
  );
}
...
function Container() {
  return (
    <div className="bg-[#0e0e0d] content-stretch flex flex-col items-start min-h-[807px] relative shrink-0 w-full" data-name="Container">
      <Header />
      <MainContent />
      <Footer />
    </div>
...
function Body() {
  return (
    <div className="content-stretch flex flex-col h-[807px] items-start min-h-[807px] relative shrink-0 w-[1425px]" data-name="Body">
      <Container />
    </div>
  );
}
...
function ImageMaximem() {
  return (
    <div className="relative shrink-0 size-[40px]" data-name="Image (Maximem)">
      <svg className="absolute block inset-0 size-full" fill="none" height="40" preserveAspectRatio="none" viewBox="0 0 40 40" width="40">
        <g id="Image (Maximem Logo)">
          <path d={svgPaths.p807ad80} fill="white" id="Vector" />
        </g>
...
function Text81() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Geist_Variable:Bold',sans-serif] leading-[45.15px] not-italic relative shrink-0 text-[30.1px] text-white tracking-[0.6971px] whitespace-nowrap">Maximem</p>
    </div>
  );
}
...
function Container79() {
  return <div className="h-[33px] relative shrink-0 w-[166px]" data-name="Container" />;
}
...
function Container81() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[15px] text-white tracking-[-0.2344px] whitespace-nowrap">Products</p>
    </div>
  );
}
...
function Link23() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Link">
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[15px] text-white tracking-[-0.2344px] whitespace-nowrap">Pricing</p>
    </div>
  );
}
...
function Link24() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Link">
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[15px] text-white tracking-[-0.2344px] whitespace-nowrap">Playground</p>
    </div>
  );
}
...
function Container82() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[15px] text-white tracking-[-0.2344px] whitespace-nowrap">Use Cases</p>
    </div>
  );
}
...
function Container83() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[15px] text-white tracking-[-0.2344px] whitespace-nowrap">Why Memory</p>
    </div>
  );
}
...
function Link25() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Link">
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[15px] text-white tracking-[-0.2344px] whitespace-nowrap">Integrations</p>
    </div>
  );
}
...
function Link26() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Link">
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[15px] text-white tracking-[-0.2344px] whitespace-nowrap">Docs</p>
    </div>
  );
}
...
function Link27() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Link">
      <p className="[word-break:break-word] font-['Geist_Variable:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[15px] text-white tracking-[-0.2344px] whitespace-nowrap">{`Blog & Resources`}</p>
    </div>
  );
}
...
function Container80() {
  return (
    <div className="absolute content-stretch flex gap-[24px] items-center left-[335px] top-[22px]" data-name="Container">
      <Container81 />
      <Link23 />
      <Link24 />
      <Container82 />
  ...
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="12" preserveAspectRatio="none" viewBox="0 0 12 12" width="12">
        <g id="Icon">
          <path d="M9.5 4.5L6 8L2.5 4.5" id="Vector" stroke="black" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
        </g>
      </svg>
    </div>
  );
...
function Button4() {
  return (
    <div className="absolute bg-white content-stretch drop-shadow-[0px_0px_6px_rgba(242,101,34,0.25)] flex gap-[6px] h-[33px] items-center left-[1226.82px] px-[20px] py-[6px] rounded-[9999px] top-[18px]" data-name="Button">
      <p className="[word-break:break-word] font-['Geist_Variable:Medium',sans-serif] leading-[21px] not-italic relative shrink-0 text-[14px] text-black text-center tracking-[-0.1504px] whitespace-nowrap">Get Started Free</p>
      <Icon25 />
    </div>
  );
}
...
function Navigation() {
  return (
    <div className="absolute backdrop-blur-[12px] bg-[rgba(0,0,0,0.8)] content-stretch flex h-[70px] items-center left-0 px-[32px] py-[12px] shadow-[0px_10px_15px_0px_rgba(0,0,0,0.1),0px_4px_6px_0px_rgba(0,0,0,0.1)] top-[0.07px] w-[1425px]" data-name="Navigation">
      <Link22 />
      <ContainerAlign />
      <Container80 />
      <Button4 />
...
export default function MaximemMemoryAndContextManagementForAiAgents() {
  return (
    <div className="bg-[#0e0e0d] content-stretch flex flex-col items-start relative size-full" data-name="Maximem | Memory and context management for AI agents">
      <Body />
      <Navigation />
      <ButtonOpenSupportChat />
      <Container84 />
      <Container103 />
    </div>
  );
