...
// ══════════════════════════════════════════════════════════════════════
// 1. BUILDER LOGOS (All in uniform monochrome grey)
// ══════════════════════════════════════════════════════════════════════

function NvidiaLogo({ isLight }: { isLight?: boolean }) {
  const color = isLight ? "#52525b" : "#a1a1aa";
  return (
    <div className="h-[28px] w-[152px] flex items-center justify-center shrink-0">
      <svg className="h-[26px] w-auto max-w-[152px]" fill="none" viewBox="0 0 146.205 26.9577">
        <g id="Group">
          <path clipRule="evenodd" d={svgPaths.p5933000} fill={color} fillRule="evenodd" />
          <path clipRule="evenodd" d={svgPaths.p126d6900} fill={color} fillRule="evenodd" />
          <path clipRule="evenodd" d={svgPaths.pb0ef200} fill={color} fillRule="evenodd" />
        </g>
      </svg>
    </div>
  );
...
function IitDelhiLogo({ isLight }: { isLight?: boolean }) {
  return (
    <div className="flex items-center gap-2.5 shrink-0">
      <img alt="IIT Delhi" className="size-[26px] object-contain shrink-0 grayscale opacity-75" src={imgImage} />
...
function LoopdeskLogo({ isLight }: { isLight?: boolean }) {
  return (
    <div className="flex items-center gap-2.5 shrink-0">
      <img alt="Loopdesk" className="h-[26px] w-[19px] object-contain shrink-0 grayscale opacity-75" src={imgImage1} />
      <span className={`font-['Geist_Variable:Semi_Bold',sans-serif] text-[17px] font-semibold tracking-[-0.015em] whitespace-nowrap ${
        isLight ? "text-[#52525b]" : "text-[#a1a1aa]"
      }`}>
        Loopdesk
  ...
  return (
    <div className="h-[28px] w-[134px] flex items-center shrink-0">
      <svg className="h-[26px] w-auto" fill="none" viewBox="0 0 141.753 29.9402">
        <g id="Razorpay">
          <path clipRule="evenodd" d={svgPaths.p19257a00} fill={color} fillRule="evenodd" />
          <path clipRule="evenodd" d={svgPaths.p17108c80} fill={color} fillRule="evenodd" />
          <path clipRule="evenodd" d={svgPaths.p3af8cb70} fill={color} fillRule="evenodd" />
          <path clipRule="evenodd" d={svgPaths.p21102100} fill={color} fillRule="evenodd" />
          <path clipRule="evenodd" d={svgPaths.p255cb080} fill={color} fillRule="evenodd" />
          <path clipRule="evenodd" d={svgPaths.p3f184600} fill={color} fillRule="evenodd" />
          <path clipRule="evenodd" d={svgPaths.p4f44580} fill={color} fillRule="evenodd" />
          <path clipRule="evenodd" d={svgPaths.p151ba240} fill={color} fillRule="evenodd" />
          <path clipRule="evenodd" d={svgPaths.p26863f80} fill={color} fillRule="evenodd" />
          <path clipRule="evenodd" d={svgPaths.p248771f1} fill={color} fillRule="evenodd" />
        </g>
      </svg>
    </div>
  );
...
function AidenLogo({ isLight }: { isLight?: boolean }) {
  return (
    <div className="flex items-center gap-2.5 shrink-0">
      <img alt="Aiden" className="size-[26px] object-contain shrink-0 grayscale opacity-75" src={imgImage2} />
      <span className={`font-['Geist_Variable:Semi_Bold',sans-serif] text-[17px] font-semibold tracking-[-0.015em] whitespace-nowrap ${
        isLight ? "text-[#52525b]" : "text-[#a1a1aa]"
      }`}>
        Aiden
    ...
    <div className="flex items-center gap-2.5 shrink-0">
      <svg className="size-[26px] shrink-0" fill="none" viewBox="0 0 26 26">
        <g clipPath="url(#warrant_clip)">
          <path d={svgPaths.p3f3b5a00} stroke={color} strokeWidth="0.3" />
          <path d={svgPaths.p633c00} stroke={color} strokeWidth="0.1" />
          <g>
            <path d={svgPaths.p2e7a0400} fill={color} />
            <path d={svgPaths.p1d8eca00} fill={color} />
            <path d={svgPaths.p33887f80} fill={color} />
            <path d={svgPaths.p15613600} fill={color} />
          </g>
          <path d="M4.46875 20.7188H21.5312" opacity="0.7" stroke={color} strokeWidth="0.15" />
        </g>
        <defs>
...
function OmnidimensionLogo() {
  return (
    <div className="h-[26px] flex items-center shrink-0">
      <img
        alt="Omnidimension"
        className="h-[24px] w-auto max-w-[152px] object-contain grayscale opacity-75"
...
function TruCommerceLogo({ isLight }: { isLight?: boolean }) {
  ...
  return (
    <div className="flex items-center gap-2.5 shrink-0">
      <svg className="size-[26px] shrink-0" fill="none" viewBox="0 0 26 26">
        <path d={svgPaths.p1e5eb100} stroke={color} strokeWidth="1.6" />
        <path d={svgPaths.p1c021a80} fill={color} />
      </svg>
      <span className={`font-['Geist_Variable:Semi_Bold',sans-serif] text-[17px] font-semibold tracking-[-0.015em] whitespace-nowrap ${
        isLight ? "text-[#52525b]" : "text-[#a1a1aa]"
      }`}>
...
function PraxelLogo({ isLight }: { isLight?: boolean }) {
  return (
    <div className="flex items-center gap-2.5 shrink-0">
      <img alt="Praxel" className="h-[26px] w-[21px] object-contain shrink-0 grayscale opacity-75" src={imgImage3} />
      <span className={`font-serif text-[18px] whitespace-nowrap ${isLight ? "text-[#52525b]" : "text-[#a1a1aa]"}`}>
        Praxel
      </span>
    </div>
  );
    ...
    <div className="h-[26px] flex items-center shrink-0">
      <div className="rotate-180 scale-x-[-1] flex items-center justify-center">
        <svg className="h-[22px] w-auto max-w-[146px]" fill="none" viewBox="0 0 126.536 29.98">
          <path d={svgPaths.p3b7e3900} fill={color} />
        </svg>
      </div>
    </div>
  );
...
function IitRoorkeeLogo({ isLight }: { isLight?: boolean }) {
  return (
    <div className="flex items-center gap-2.5 shrink-0">
      <img alt="IIT Roorkee" className="size-[26px] object-contain shrink-0 grayscale opacity-75" src={imgImage4} />
      <span className={`font-['Geist_Variable:Semi_Bold',sans-serif] text-[17px] font-semibold tracking-[-0.015em] whitespace-nowrap ${
        isLight ? "text-[#52525b]" : "text-[#a1a1aa]"
      }`}>
        IIT Roorkee
    ...
    <div className="flex items-center gap-2.5 shrink-0">
      <svg className="h-[26px] w-[35px] shrink-0" fill="none" viewBox="0 0 35 26">
        <g clipPath="url(#uncypher_clip)">
          <path d={svgPaths.p238fc380} fill={color} />
          <path d={svgPaths.p2e7f5e80} fill={color} />
          <path d={svgPaths.p32415b00} fill={color} />
          <path d={svgPaths.p2dd7b880} fill={color} />
        </g>
        <defs>
  ...
  return (
    <div className="h-[28px] w-[88px] flex items-center shrink-0">
      <svg className="h-[26px] w-auto" fill="none" viewBox="0 0 86 36">
        <g id="Agno">
          <path d={svgPaths.p2a44f000} fill={color} />
          <path d={svgPaths.p21881780} fill={color} />
          <path clipRule="evenodd" d={svgPaths.p20bdfa80} fill={color} fillRule="evenodd" />
          <path d={svgPaths.p109efa00} fill={color} />
          <path clipRule="evenodd" d={svgPaths.p2bab3680} fill={color} fillRule="evenodd" />
          <path d={svgPaths.p13428200} fill={color} />
        </g>
      </svg>
    </div>
  );
...
function BitsPilaniLogo({ isLight }: { isLight?: boolean }) {
  return (
    <div className="flex items-center gap-2.5 shrink-0">
      <img alt="BITS Pilani" className="size-[26px] object-contain shrink-0 grayscale opacity-75" src={imgImage5} />
      <span className={`font-['Geist_Variable:Semi_Bold',sans-serif] text-[17px] font-semibold tracking-[-0.015em] whitespace-nowrap ${
        isLight ? "text-[#52525b]" : "text-[#a1a1aa]"
      }`}>
        BITS Pilani
  ...
  return (
    <div className="h-[26px] w-[146px] flex items-center shrink-0">
      <svg className="h-[22px] w-auto" fill="none" viewBox="0 0 150 26">
        <path d={svgPaths.p43d7200} fill={color} />
        <path d={svgPaths.peb50880} fill={color} />
        <path d={svgPaths.p23c64f00} fill={color} />
        <path d={svgPaths.p19cc5f00} fill={color} />
        <path d={svgPaths.p38718200} fill={color} />
        <path d={svgPaths.p3b850500} fill={color} />
        <path d={svgPaths.pb563f00} fill={color} />
        <path d={svgPaths.paefac00} fill={color} />
        <path d={svgPaths.p3bf0f780} fill={color} />
        <path d={svgPaths.p2bb625e0} fill={color} />
        <path d={svgPaths.p12193280} fill={color} />
        <path d={svgPaths.p1f9cdd80} fill={color} />
      </svg>
    </div>
  );
}
...
function MindloopLogo({ isLight }: { isLight?: boolean }) {
  return (
    <div className="flex items-center gap-2.5 shrink-0">
      <img alt="Mindloop" className="size-[26px] object-contain shrink-0 grayscale opacity-75" src={imgImage6} />
      <span className={`font-['Geist_Variable:Semi_Bold',sans-serif] text-[17px] font-semibold tracking-[-0.015em] whitespace-nowrap ${
        isLight ? "text-[#52525b]" : "text-[#a1a1aa]"
      }`}>
        Mindloop
...
function ClearVueLogo() {
  return (
    <div className="h-[26px] flex items-center shrink-0">
      <img alt="ClearVUE" className="h-[24px] w-auto max-w-[146px] object-contain grayscale opacity-75" src={imgImageClearVue} />
    </div>
  );
}
...
function HandaUncleLogo({ isLight }: { isLight?: boolean }) {
  return (
    <div className="flex items-center gap-2.5 shrink-0">
      <img alt="HandaUncle" className="h-[26px] w-[29px] object-contain shrink-0 grayscale opacity-75" src={imgImage7} />
      <span className={`font-['Geist_Variable:Semi_Bold',sans-serif] text-[17px] font-semibold tracking-[-0.015em] whitespace-nowrap ${
        isLight ? "text-[#52525b]" : "text-[#a1a1aa]"
      }`}>
        HandaUncle
  ...
  return (
    <div className="h-[26px] flex items-center shrink-0">
      <img
        ...
        className="h-[22px] w-auto max-w-[124px] object-contain grayscale opacity-75"
...
function HellloLogo({ isLight }: { isLight?: boolean }) {
  return (
    <div className="flex items-center gap-2.5 shrink-0">
      <img alt="helllo" className="size-[26px] object-contain shrink-0 grayscale opacity-75" src={imgImage8} />
      <span className={`font-['Geist_Variable:Semi_Bold',sans-serif] text-[17px] font-semibold tracking-[-0.015em] whitespace-nowrap ${
        isLight ? "text-[#52525b]" : "text-[#a1a1aa]"
      }`}>
        helllo
...
function HectorAiLogo({ isLight }: { isLight?: boolean }) {
  const color = isLight ? "#52525b" : "#a1a1aa";
  return (
    <div className="h-[28px] w-[130px] flex items-center shrink-0">
      <svg className="h-[26px] w-auto" fill="none" viewBox="0 0 125 31">
        <path d={svgPaths.p3ca40000} fill={color} />
        <path d={svgPaths.p1b59c400} fill={color} />
        <path d={svgPaths.p3644f240} fill={color} />
        <path d={svgPaths.p36e15280} fill={color} />
        <path d={svgPaths.p2e704700} fill={color} />
        <path d={svgPaths.p3efc9280} fill={color} />
        <path d={svgPaths.p1a5aa200} fill={color} />
        <path d={svgPaths.p2bd9b880} fill={color} />
        <path d={svgPaths.p545fd80} fill={color} />
        <path d={svgPaths.p1be67c80} fill={color} />
      </svg>
    </div>
  );
}
...
// ══════════════════════════════════════════════════════════════════════
// 2. PRESS / FEATURED IN LOGOS (Uniform monochrome grey)
// ══════════════════════════════════════════════════════════════════════

function FinancialExpressLogo({ isLight }: { isLight?: boolean }) {
  const color = isLight ? "#52525b" : "#a1a1aa";
  return (
    <div className="h-[28px] w-[212px] flex items-center shrink-0">
      <svg className="h-[24px] w-auto max-w-[212px]" fill="none" viewBox="0 0 220.001 25.6559">
        <g id="FinancialExpress">
          <path d={svgPaths.p2862c800} fill={color} />
          <path d={svgPaths.p11662500} fill={color} />
          <g>
            <path d={svgPaths.p24ad7600} fill={color} />
            <path d={svgPaths.p215bbf00} fill={color} />
            <path d={svgPaths.p1f455700} fill={color} />
          </g>
        </g>
      </svg>
    </div>
  ...
  return (
    <div className="h-[24px] w-[200px] flex items-center shrink-0">
      <svg className="h-[17px] w-auto max-w-[200px]" fill="none" viewBox="0 0 218.695 15.059">
        <g id="TimesOfIndia">
          <path d={svgPaths.p40d1e80} fill={color} />
          <path d={svgPaths.p1278fa70} fill={color} />
          <path d={svgPaths.pb360100} fill={color} />
          <path d={svgPaths.pf27a100} fill={color} />
          <path d={svgPaths.p26e26380} fill={color} />
          <path d={svgPaths.p1f9b49c0} fill={color} />
          <path d={svgPaths.p2ad48900} fill={color} />
          <path d={svgPaths.p844f680} fill={color} />
          <path d={svgPaths.p382b3f00} fill={color} />
          <path d={svgPaths.p25f7b280} fill={color} />
          <path d={svgPaths.p107b3900} fill={color} />
          <path d={svgPaths.p3e53e800} fill={color} />
          <path d={svgPaths.p2c473890} fill={color} />
          <path d={svgPaths.p222b5500} fill={color} />
          <path d={svgPaths.p3fb31b00} fill={color} />
        </g>
      </svg>
    </div>
  );
...
// ══════════════════════════════════════════════════════════════════════
// 3. SUPPORTED BY LOGOS (Monochrome greyed out)
// ══════════════════════════════════════════════════════════════════════
  ...
  return (
    <div className="h-[36px] w-[124px] flex items-center justify-center shrink-0">
      <svg className="h-[31px] w-auto" fill="none" viewBox="0 0 99.8574 36.7028">
        <path d={svgPaths.p14aac040} fill={color} />
      </svg>
    </div>
  );
}
    ...
    <div className="h-[26px] flex items-center gap-2 shrink-0">
      <div className="rotate-180 scale-x-[-1] flex items-center shrink-0">
        <svg className="h-[19px] w-[59px] shrink-0" fill="none" viewBox="0 0 52.8964 17.293">
          <g id="google_letters">
            <path d={svgPaths.p36970c00} fill={color} />
            <path d={svgPaths.p2f0fba80} fill={color} />
            <path d={svgPaths.p1aab9200} fill={color} />
            <path d={svgPaths.p21099100} fill={color} />
            <path d={svgPaths.p3a33ff00} fill={color} />
            <path d={svgPaths.p1d96eb00} fill={color} />
          </g>
        </svg>
      </div>
      ...
      <svg className="h-[16.5px] w-[97px] shrink-0" fill="none" viewBox="0 0 83.9075 15.6739">
        <g opacity="0.9">
          <path d={svgPaths.p2ec85500} fill={color} />
          <path d={svgPaths.p2abe3880} fill={color} />
          <path d={svgPaths.p152757b0} fill={color} />
          <path d={svgPaths.p2d132500} fill={color} />
          <path d={svgPaths.p1926bff2} fill={color} />
          <path d={svgPaths.p2f027e00} fill={color} />
          <path d={svgPaths.p1543a080} fill={color} />
          <path d={svgPaths.p76ac800} fill={color} />
          <path d={svgPaths.p1feadc00} fill={color} />
          <path d={svgPaths.pc6fe300} fill={color} />
        </g>
      </svg>
    </div>
  );
...
function Neo4jLogo({ isLight }: { isLight?: boolean }) {
  const color = isLight ? "#52525b" : "#a1a1aa";
  return (
    <div className="h-[28px] flex items-center shrink-0">
      <svg className="h-[24px] w-auto" viewBox="0 0 94 28" fill="none">
        <circle cx="5.5" cy="14" r="3.2" fill={color} />
        <circle cx="14" cy="6.5" r="3.6" fill={color} />
        <circle cx="14" cy="21.5" r="3.6" fill={color} />
        <path d="M5.5 14L14 6.5M5.5 14L14 21.5" stroke={color} strokeWidth="2.2" strokeLinecap="round" />
        <text
          x="23"
          y="20"
          fill={color}
  ...
  return (
    <div className="h-[31px] w-[99px] flex items-center shrink-0">
      <svg className="h-[28px] w-auto" fill="none" viewBox="0 0 88.8125 32.9922">
        <g id="Cloudflare">
          <path d={svgPaths.p260e4a80} fill={color} />
          <path d={svgPaths.p1577e280} fill={color} />
          <path d={svgPaths.p2d06ec00} fill={color} />
          <path d={svgPaths.p3670bc00} fill={color} />
        </g>
      </svg>
    </div>
  );
...
function PoweredByAwsLogo({ isLight }: { isLight?: boolean }) {
  return (
    <div className="h-[28px] flex items-center shrink-0">
      <img
        alt="Powered by AWS"
        className={`h-[26px] w-auto max-w-[92px] object-contain grayscale opacity-75 ${
...
export default function CredibilitySection({ isLight = false }: CredibilitySectionProps) {
  ...
  // Exact builder logos starting with the order from the example screenshot
  const allBuilderLogos = [
    ...
    { id: "hector-ai", comp: <HectorAiLogo isLight={isLight} /> },
            ...
            >
              ...
              <div className="flex items-center gap-10 sm:gap-14 lg:gap-16 shrink-0 pr-10 sm:pr-14 lg:pr-16">
                {allBuilderLogos.map((item) => (
                  <div
                    key={`set1-${item.id}`}
                    className="opacity-75 hover:opacity-100 transition-opacity duration-200 cursor-default shrink-0 flex items-center"
                  >
                    {item.comp}
                  </div>
                ))}
              ...
              {/* Set 2 (Exact duplicate for 100% seamless loop) */}
              <div
